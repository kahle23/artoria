...
public abstract class AbstractCodeBuilder implements CodeBuilder {
    private static Logger log = LoggerFactory.getLogger(AbstractCodeBuilder.class);
    ...
    protected AbstractCodeBuilder(String name, Renderer engine) {
        this.engine = engine;
        this.name = name;
    }
    ...
    protected String templateContent(BuildContext context) {
