...
public class SimpleBuildContext implements BuildContext {
    ...
    private Map<String, Map<String, String>> outputPathMap = new HashMap<String, Map<String, String>>();
    private Map<String, Map<String, Object>> tableInfoMap = new HashMap<String, Map<String, Object>>();
